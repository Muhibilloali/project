      ...
      <div className='calculator'>
        <form action = ''>
          ...
          <div className='keypad'>
            <input type='button' className='ac_operator' value="AC" onClick={e => setValue('')}></input>
            <input type='button' className='de_operator' value="DE" onClick={e => setValue(value.slice(0, -1))}></input>
            <input type='button' className='operator' value="." onClick={e => setValue(value + e.target.value)}></input>
            <input type='button' className='operator' value="/" onClick={e => setValue(value + e.target.value)}></input>
          </div>
          ...
          <div>
            ...
            <input type='button' value="=" className='equal_operator' onClick={e => setValue(eval(value))}></input>
          </div>
        </form>
      </div>
    </div>
